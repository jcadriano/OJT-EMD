    ...
    <table class="sheet">
        ...
        <tr>
            ...
            <th> ST Term. Qty </th>
            <th> Make Contact Point Lot No. </th>
            <th> Make C.P Bag No. </th>
            <th> Make C.P Qty </th>
        </tr>
        <tr class="newRow">
            ...
            <td> <input type="text" name="stMake_lotNum[]" required="required"> </td> <!-- st make lot no -->
            <td class="smaller"> <input type="text" class="number" name="stMake_qty[]" required="required"> </td> <!-- st make qty --> 
            <td> <input type="text" name="movecp_lotNum[]" required="required"> </td> <!-- make cp lot no -->
            <td class="smaller"> <input type="text" class="number" name="movecp_bagNum[]" required="required"> </td> <!-- make cp bag no --> 
            <td class="smaller"> <input type="text" class="number" name="movecp_qty[]" required="required"> </td> <!-- make cp qty -->
    ...
    <script>
        ...
        $('#addRow').click (function () {
            var newRow = "<tr class='newRow'>" + 
                            " <td> " + 
                                "<input type='text' name='stMake_lotNum[]' placeholder='ST Make Lot #'> " + 
                            " </td> " + 
                            " <td> " + 
                                "<input type='text' class='number' name='stMake_qty[]' placeholder='ST Make Qty'> " + 
                            " </td> " +
                            " <td> " + 
                                "<input type='text' name='movecp_lotNum[]' placeholder='Move CP Lot #'> " + 
                            " </td> " +
                            " <td> " + 
                                "<input type='text' class='number' name='movecp_bagNum[]' placeholder='Move CP Bag #'> " + 
                            " </td> " +
                            " <td> " + 
                                "<input type='text' class='number' name='movecp_qty[]' placeholder='Move CP Qty'> " + 
                            " </td> " +
                         "</tr>";
